import uuid, json, time, urllib.parse

from flask import Blueprint, request, make_response, url_for, flash, redirect, abort
from flask import render_template
from flask_login import login_user, logout_user, current_user
from flask_wtf import Form
from wtforms import StringField, SelectField, BooleanField, PasswordField, HiddenField, validators, ValidationError
...
class RegisterForm(Form):
    ...
    n = StringField('Email Address', [validators.Length(min=3, max=35)])
